 ...
 *
 * Aggressive-but-clear settings matching the SDK's "small liveness clip" budget:
 * ~720p max, modest bitrate, 15fps. All calls are expected on a single worker
 * thread owned by [LivenessRecorder].
 */
class LivenessVideoEncoder(
  private val width: Int,
  private val height: Int,
  private val outputPath: String,
  private val rotationDegrees: Int,
) {
  private val tag = "KycLivenessEncoder"
